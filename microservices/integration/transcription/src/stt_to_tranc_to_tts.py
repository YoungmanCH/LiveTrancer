...
# Define a function to process the text via ChatGPT and speak it via VoiceVox
async def process_and_speak(transcript):
    processed_text = process_text_with_chatgpt(transcript)
    print(f"Processed Text: {processed_text}")
    
    # Use Voicevox to speak the processed text asynchronously
    await asyncio.to_thread(voice.speak, processed_text)
